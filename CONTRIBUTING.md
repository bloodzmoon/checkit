...
Our linter will catch most styling issues that may exist in your code. You can check the status of your code styling by simply running `npm run format` after building the project locally.
...
```
$ git clone https://github.com/YOUR-USERNAME/checkit
```
...
1. Find the [New Pull Request](https://github.com/bloodzmoon/checkit/compare/) button
